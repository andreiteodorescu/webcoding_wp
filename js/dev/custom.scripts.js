...
$(function(){
    ...
    $(".staging").mousemove(function( event ) {
        var w = $(this).width(),
            ...
            pct = mouseXpercentage = Math.round(event.pageX / w * 100),
            bg = "linear-gradient(45deg,#58e7f5 0,#01cfe3 " + pct + "%,rgba(79, 59, 219, 0.8) 100%)";
    ...
    $(window).scroll(function() {
        ...
        if ($(this).scrollTop() > 0) {
            $('.dive-down').addClass('disappear');
        }
        else {
            $('.dive-down').removeClass('disappear');
        }
    });
