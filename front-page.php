...
<main class="main">
        ...
        <div class="container">
            <div class="row d-block d-lg-flex align-items-xl-center">
                <div class="col-lg-3 col-xl-6 text-center mb-5 mb-lg-0">
                    <img class="img-fluid img-shadow" src="<?php bloginfo('template_directory'); ?>/images/andrei_teodorescu.jpg" alt="Andrei Teodorescu" width="500" data-aos="zoom-in" data-aos-duration="1000" data-aos-offset="150" data-aos-once="true">
                </div>

                <div class="col-lg-9 col-xl-6 component-about-info text-center text-lg-left">
                    <h2 class="general-title component-about-info-title" data-aos="fade-down" data-aos-duration="1000" data-aos-offset="150" data-aos-once="true">10 Years experience</h2>
                    <p class="component-about-info-undertitle" data-aos="fade-up" data-aos-duration="1000" data-aos-offset="150" data-aos-once="true">
                        My name is Andrei Teodorescu, I'm a Front-End Developer who loves to create fully responsive, intuitive and dynamic user experiences. I'm always motivated and have the desire to learn more.
                        <br>
    ...
    <div class="separator component-margin" data-aos="zoom-in" data-aos-duration="2000" data-aos-offset="200" data-aos-once="true"></div>

    <div class="component-portfolio component-margin">
        <div class="container">
            <h4 class="general-title text-center" data-aos="fade-down" data-aos-duration="1000" data-aos-offset="200" data-aos-once="true">Clients</h4>
            <div class="row">
                <?php
                ...
                <?php while ($portfolio->have_posts()) : $portfolio->the_post(); ?>
                    <div class="col-md-6 component-portfolio-item" data-aos="zoom-in" data-aos-duration="1000" data-aos-offset="200" data-aos-once="true">
